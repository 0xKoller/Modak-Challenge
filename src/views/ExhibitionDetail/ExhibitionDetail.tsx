      ...
      <View style={styles.container}>
        ...
        <View style={styles.description}>
          <View style={styles.divider}>
            ...
            {exhibition.gallery_title !== undefined && exhibition.gallery_title !== null && (
              <Text style={styles.headings}>
                Been displayed at: <Text style={styles.value}> {exhibition.gallery_title} </Text>
              </Text>
            )}

            <Text style={styles.headings}>
              Status: <Text style={styles.value}> {exhibition.status} </Text>
            </Text>
            {exhibition.short_description !== undefined && (
              <Text style={styles.headings}>
                Description: <Text style={styles.value}> {exhibition.short_description} </Text>
              </Text>
            )}
          </View>
          <View style={styles.divider}>
            ...
            <View style={styles.dates}>
              {exhibition.aic_start_at !== undefined && (
                <Text style={styles.headings}>
                  From: <Text style={styles.value}> {exhibition.aic_start_at} </Text>
                </Text>
              )}
              {exhibition.aic_end_at !== undefined && (
                <Text style={styles.headings}>
                  To: <Text style={styles.value}> {exhibition.aic_end_at} </Text>
                </Text>
              )}
            </View>
          </View>
          {exhibition.artwork_titles && exhibition.artwork_titles.length > 0 && (
            <View style={styles.divider}>
              <Text style={styles.subtitle}>Artworks</Text>
              <View>
                {exhibition.artwork_titles?.map((artwork) => (
                  <Text key={artwork} style={styles.artworks}>
                    - {artwork}
                  </Text>
                ))}
              </View>
