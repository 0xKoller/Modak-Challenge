    ...
    <View style={styles.container}>
      {exhibitions?.map((exhibition) => (
        <View style={styles.exhibition} key={exhibition.id}>
          {exhibition.image_url !== null && <Image style={styles.image} source={{ uri: `${exhibition.image_url}` }} />}
          <View style={styles.detail}>
            <Text style={styles.title}>{exhibition.title}</Text>
            {exhibition.gallery_title !== null && (
              <Text style={styles.subtitle}>Been displayed at {exhibition.gallery_title}</Text>
            )}
